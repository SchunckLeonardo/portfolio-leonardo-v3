  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-2/4 top-2/4 z-10 h-popup w-popup -translate-x-2/4 -translate-y-2/4 animate-content rounded-lg bg-slate-900 p-16 text-white">
          {children}
